...
Options:
  ...
  -tsv                          Subject tracker tsv-file (default: \$derivatives/Subject_Tracker_for_dmri_tractography_pipeline.tsv)
...
# Defaults cont'd
tsvfile=$derivatives/Subject_Tracker_for_dmri_tractography_pipeline.tsv
